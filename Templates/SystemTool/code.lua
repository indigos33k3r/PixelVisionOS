...
function Init()
  ...
  -- DrawText(messageTxt, 1, 6, DrawMode.Tile, "large", 15, 0, 31)
...
function OnMenuQuit()
  ...
  --
  -- Configure hSlider
  hSliderData = editorUI:CreateSlider(1, {x = 8, y = 107, w = 112, h = 16}, "hsliderhandle", "This is a horizontal slider.", true)
  hSliderData.onAction = OnValueChange

  vSliderData = editorUI:CreateSlider(11, {x = 235, y = 104, w = 16, h = 72}, "vsliderhandle", "This is a vertical slider")
  vSliderData.onAction = OnValueChange

  knobData = editorUI:CreateKnob(11, {x = 208, y = 104, w = 24, h = 24}, "knob", "This is a knob")
  knobData.onAction = OnValueChange

  -- Buttons
  backBtnData = editorUI:CreateButton(8, {x = 200, y = 184}, "stepperback", "This is the picker back button.")
  backBtnData.onAction = OnPickerBack

  nextBtnData = editorUI:CreateButton(10, {x = 224, y = 184}, "steppernext", "This is the picker next button.")
  nextBtnData.onAction = OnPickerNext
  ...
  pickerInputData = editorUI:CreateInputField(9, {x = 216, y = 192, w = 8}, "0", "You are on page %s of 9. Enter new page number.", "number")
  pickerInputData.min = 1
  pickerInputData.max = 9
  pickerInputData.onAction = UpdatePickerButtons
  ...
  radioButtonGroupData = editorUI:CreateToggleGroup(7, true)
  radioButtonGroupData.onAction = OnRadioButton
