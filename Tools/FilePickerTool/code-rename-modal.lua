RenameModal = {}
RenameModal.__index = RenameModal

function RenameModal:Init()

  local _renameModal = {} -- our new object
  setmetatable(_renameModal, RenameModal) -- make Account handle lookup
...
function RenameModal:SetText(inputText)
...
function RenameModal:GetText()
  return self.inputField.text
end

function RenameModal:Open()
...
function RenameModal:Update(timeDelta)
